...
def juego_game_over():
    ...
    while running_flag:
        ...
        muestra_texto(pantalla,"Odachi", "TE COMIERON LOS ZOMBIES!!!",ROJO, 100, ANCHO_VENTANA//2,ALTO_VENTANA//2)
        muestra_texto(pantalla,"Odachi", "- PRESIONA ENTER PARA REINTENTAR",ROJO_CUATRO, 60, ANCHO_VENTANA//2,ALTO_VENTANA//2 + 180)
        muestra_texto(pantalla,"Odachi", "- PRESIONA R PARA VER EL RANKING",ROJO_CUATRO, 60, ANCHO_VENTANA//2,ALTO_VENTANA//2 + 250)
